...
import app.ij.mlwithtensorflowlite.ml.Modelangka;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pindah = new Intent(MainActivity2.this, MainActivity4.class);
        ...
        camera2 = findViewById(R.id.imageView);
    ...
    public void classifyImage(Bitmap image){
        try {
            Modelangka model = Modelangka.newInstance(getApplicationContext());
            ...
            Modelangka.Outputs outputs = model.process(inputFeature0);
